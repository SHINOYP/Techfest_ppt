...
const Card = () => {
  ...
  return (
    ...
    <div style={{ perspective: 2000 }}>
      ...
      >
        {/* card title */}
        <h1 className='text-5xl mb-6 font-extrabold'>VR </h1>
        {/* card subtitle */}
        <p className='max-w-[300px] text-[#000000] mb-6'>
          What is Virtural Reality?, What is Augmented reality ? <br/>
          Where these technologies comes to play ? And much more
        </p>
        {/* btn & price wrapper */}
        ...
        <motion.div
          ...
          className='absolute top-12 -right-64 w-[400px]'
        >
          <img src={vr} alt='' draggable='false' />
        </motion.div>
      </motion.div>
    </div>
  );
