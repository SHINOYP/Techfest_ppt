...
const Card = () => {
  ...
  return (
    ...
    <div style={{ perspective: 2000 }}>
      ...
      >
        {/* card title */}
        <h1 className='text-5xl mb-6 font-extrabold'>IOT</h1>
        {/* card subtitle */}
        <p className='max-w-[300px] text-[#000000] mb-6'>
          What is really iot? <br/> why it is important?<br/>
          If you dont know you shoud know
        </p>
        {/* btn & price wrapper */}
        ...
        >
          <img src={iot} alt='' draggable='false' />
        </motion.div>
      </motion.div>
    </div>
  );
